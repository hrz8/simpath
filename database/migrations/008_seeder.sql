...
INSERT INTO scopes (id, "scope", description, is_default, created_at, updated_at) VALUES
  ...
  (3, 'openid','Open ID Connect',false,'2024-09-19 00:00:00.000','2024-09-19 00:00:00.000');
INSERT INTO clients (id, client_id, client_secret, redirect_uri, app_name, created_at, updated_at) VALUES
  (1, '600ef080-d02c-426d-bf79-64247ba0fc90','$2a$10$CUoGytf1pR7CC6Y043gt/.vFJUV4IRqvH5R6F0VfITP8s2TqrQ.4e','http://localhost:8088/signin','Test Client ABC','2024-09-19 00:00:00.000','2024-09-19 00:00:00.000');
